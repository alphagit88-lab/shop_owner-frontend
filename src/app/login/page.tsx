      ...
      <Card className="w-full max-w-md border-zinc-800 bg-black/40 backdrop-blur-xl shadow-2xl relative">
        <CardHeader className="space-y-2 text-center">
          <div className="flex justify-center mb-2">
            <div className="p-3 rounded-2xl bg-gradient-to-br from-amber-400 to-amber-600 shadow-lg shadow-amber-500/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-white/5 border-zinc-800 text-white placeholder:text-zinc-600 focus:ring-amber-500/50"
                required
              />
            </div>
            <div className="space-y-2">
            ...
            <Button 
              type="submit" 
              className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-black font-semibold h-11 shadow-lg shadow-amber-500/10"
              disabled={loading}
            >
