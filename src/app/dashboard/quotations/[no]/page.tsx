    ...
    <div className="space-y-6 animate-in fade-in duration-500 max-w-5xl mx-auto px-4 md:px-0">
      <div className="hidden print:flex flex-row items-center justify-between border-b-2 border-zinc-100 pb-8 mb-8">
        ...
        <div className="text-right">
          <h2 className="text-3xl font-black text-zinc-900 uppercase tracking-tighter">QUOTATION</h2>
          <div className="mt-1 space-y-0.5">
            <p className="text-sm font-bold text-zinc-600">#{quotation.quotationNo.toString().padStart(5, '0')}</p>
            <p className="text-[10px] text-zinc-400 font-medium">{new Date(quotation.quotationDate).toLocaleDateString('en-GB', { day: '2-digit', month: 'long', year: 'numeric' })}</p>
          </div>
        </div>
      </div>
